...
.PHONY: venv install install-dev lint format format-check typecheck test audit build check clean activate
...
install-dev: install
	$(UV) pip install ruff ty==0.0.63 pytest pytest-asyncio pip-audit bandit
